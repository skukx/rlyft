...
describe Lyft::Client::Api::Availability, '#nearby_drivers' do
  let(:request_path) { "/#{Lyft::Client::Api::VERSION}/drivers" }
  let(:inputs) do
    {
      lat: 37.7772,
      lng: -122.4233
  ...
  it 'should be successful' do
    resp = subject.nearby_drivers access_token: access_token, params: inputs
