...
describe Lyft::Client::Api::Availability, '#ride_types' do
  let(:request_path) { "/#{Lyft::Client::Api::VERSION}/ridetypes" }
  let(:inputs) do
    {
      lat: 37.7772,
      lng: -122.4233
  ...
  it 'should be successful' do
    resp = subject.ride_types access_token: access_token, params: inputs
